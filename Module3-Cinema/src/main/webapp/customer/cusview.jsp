                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                <c:forEach var="movieTime" items="${movieTimes}">
                                    <c:if test="${movieTime.movieId == movie.id}">
                                        <li class="list-group-item bg-dark text-white">
                                            Ngày: ${movieTime.showDate} - Giờ: ${movieTime.showTime}
                                        </li>
                                    </c:if>
                                </c:forEach>
                            </ul>
                            <a href="customer?action=booking&movieId=${movie.id}" class="btn btn-warning mt-3">Đặt
                                vé</a>
                        </div>
                    </div>
                </div>
